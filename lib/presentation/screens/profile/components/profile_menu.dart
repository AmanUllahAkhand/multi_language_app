...
import 'package:multi_language_app/presentation/screens/profile/components/profile_item.dart';
        ...
        GestureDetector(
          onTap: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context)=>const SettingScreen(image: 'assets/profile_pic.jpg')));
